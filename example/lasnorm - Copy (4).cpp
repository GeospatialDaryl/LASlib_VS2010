  ...
  */
  ...
  while (lasreader->read_point())
  {
	...
	*/
	...
	//int pX = int( (dfGeoX - adfInvGeoTransform[0] )/ adfInvGeoTransform[1] );
    //int pY = int( (dfGeoY - adfInvGeoTransform[3] )/ adfInvGeoTransform[5] );
	...
	*/
	...
	//fprintf(stdout,"yLL, dfGeoY, dfGeoX - yLL:  %18.7f %18.7f %18.7f \n",yLL,dfGeoY, dfGeoY - yLL);
	...
	//GDALDatasetRasterIO(hSrcDS,GF_Read,pX,pY,1,1,bufPixel,1,1,GDT_Float32, 1, NULL, 0, 0, 0);
